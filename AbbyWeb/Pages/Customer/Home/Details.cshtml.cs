...
namespace AbbyWeb.Pages.Customer.Home
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            {
                ShoppingCart shoppingCartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(filter: u => u.ApplicationUserId == ShoppingCart.ApplicationUserId
                ...
                {
                    _unitOfWork.ShoppingCart.IncrementShoppingCart(shoppingCartFromDb, ShoppingCart.Count);
                }
